...
import { matchPrecache, precache, precacheAndRoute, cleanupOutdatedCaches } from 'workbox-precaching'
...
setCatchHandler(({ event }) => {
    ...
    switch (event.request.destination) {
        case 'document':
            ...
            return precache('/fallback');
            // return caches.match('/fallback')
            break
        case 'image':
            // If using precached URLs:
            return precache('/static/images/fallback.png');
